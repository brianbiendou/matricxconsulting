...
const Contact: React.FC = () => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      // Envoi via Web3Forms (les soumissions arrivent sur consultingmatricx@gmail.com)
      const web3FormData = new FormData()
      web3FormData.append('access_key', 'fc5e52de-0eb4-461d-9000-04071ac5e791')
      web3FormData.append('name', formData.name)
      web3FormData.append('email', formData.email)
      web3FormData.append('company', formData.company || 'Non renseigné')
      web3FormData.append('phone', formData.phone)
      web3FormData.append('message', formData.message)
      web3FormData.append('subject', `Nouveau message de ${formData.name} - MatriCx Website`)
      web3FormData.append('from_name', 'MatriCx Website')
          ...
          <div>
            ...
            <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-primary-100 hover:border-primary-300">
              ...
              <div>
                ...
                <a href="mailto:contact@matricxconsulting.com" className="text-primary-600 font-medium hover:text-primary-700 font-primary break-all">
