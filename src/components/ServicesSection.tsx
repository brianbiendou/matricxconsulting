        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between p-6 lg:p-10">
              ...
              <div className="mb-4">
                <span 
                  className="block text-3xl lg:text-4xl font-black text-white leading-tight"
                  style={{ textShadow: '4px 4px 16px rgba(0,0,0,0.95), 0 0 40px rgba(0,0,0,0.8)' }}
                >
                  MatriCx
                </span>
                <span 
                  className="block text-3xl lg:text-4xl font-black leading-tight"
                  style={{ color: '#FDC300', textShadow: '4px 4px 16px rgba(0,0,0,0.95), 0 0 40px rgba(0,0,0,0.8)' }}
                >
                  Training &
                </span>
                <span 
